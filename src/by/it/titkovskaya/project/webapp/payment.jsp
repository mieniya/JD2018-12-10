...
<div class="container">
    ...
    <form class="form-horizontal-${account.id}">
        <div class="row">
            <div class="col-md-3">Enter payment (transfer) amount in ${account.currency}
            which will be transferred from your account № ${account.number}</div>
            <div class="col-md-4">Enter recipient data</div>
        </div>
    </form>
