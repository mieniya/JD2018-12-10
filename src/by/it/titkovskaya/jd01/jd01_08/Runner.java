...
print(s1.add(s2)); //выведет в консоль 6.0
print(s1.sub(s1)); //выведет в консоль 0.0
print(s1.mul(s1)); //выведет в консоль 9.0
print(s1.div(s1)); //выведет в консоль 1.0
