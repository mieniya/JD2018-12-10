...
import by.it.lyakhova.jd03_03.ConnCreator;
...
public abstract class AbstractDao {
    ...
    static int executeUpdate(String sql, @SuppressWarnings("SameParameterValue") boolean returnLastID) throws SQLException {
        int result;
        try (Connection connection = ConnCreator.getConnection();
             Statement statement = connection.createStatement()) {
