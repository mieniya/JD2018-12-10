...
public class TaskC {
    ...
    private static void fillTables() {
        try(Connection connection = ConnCreator.getConnection();
            ...
            statement.executeUpdate("INSERT INTO tour_type (id, type) VALUES (DEFAULT, NULL);");
            ...
            statement.executeUpdate("INSERT INTO housing (id, type) VALUES (DEFAULT, NULL);");
    ...
    private static void deleteTables() {
        try(Connection connection = ConnCreator.getConnection();
            ...
            statement.executeUpdate("DROP TABLE IF EXISTS tours_has_users ;");
            statement.executeUpdate("DROP TABLE IF EXISTS users ;");
            statement.executeUpdate("DROP TABLE IF EXISTS roles ;");
            statement.executeUpdate("DROP TABLE IF EXISTS tours ;");
            statement.executeUpdate("DROP TABLE IF EXISTS tour_type ;");
            statement.executeUpdate("DROP TABLE IF EXISTS place ;");
            statement.executeUpdate("DROP TABLE IF EXISTS transport ;");
            statement.executeUpdate("DROP TABLE IF EXISTS housing ;");
        } catch (SQLException e){
            e.printStackTrace();
        }
    }
