...
-- -----------------------------------------------------
-- Table `zagurskaya`.`operationHasEntries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zagurskaya`.`operationHasEntries` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `operationId` INT NOT NULL,
  `entryId` INT NOT NULL,
  INDEX `fk_operation_has_entrys_entrys1_idx` (`entryId` ASC),
  INDEX `fk_operation_has_entrys_operation1_idx` (`operationId` ASC),
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_operation_has_entrys_entrys1`
    FOREIGN KEY (`entryId`)
    REFERENCES `zagurskaya`.`sprEntries` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (100001, 'Получено валюты', 840, '', '1010000000840', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (100002, 'Получено валюты', 978, '', '1010000000978', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (100003, 'Получено валюты', 643, '', '1010000000643', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (100004, 'Получено валюты', 933, '', '1010000000933', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (1001, 'Покупка валюты(840)', 840, '1010000000840', '6901000000840', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (1002, 'Рублевый эквивалент(840)', 933, '6911000000840', '1010000000933', 1, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (1003, 'Покупка валюты(978)', 978, '1010000000978', '6901000000978', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (1004, 'Рублевый эквивалент(978)', 933, '6911000000978', '1010000000933', 1, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (1005, 'Покупка валюты(643)', 643, '1010000000643', '6901000000643', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (1006, 'Рублевый эквивалент(643)', 933, '6911000000643', '1010000000933', 1, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (2001, 'Продажа валюты(840)', 840, '6901000000840', '1010000000840', 1, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (2002, 'Рублевый эквивалент(840)', 933, '1010000000840', '6911000000840', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (2003, 'Продажа валюты(978)', 978, '6901000000978', '1010000000978', 1, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (2004, 'Рублевый эквивалент(978)', 933, '1010000000978', '6911000000978', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (2005, 'Продажа валюты(643)', 643, '690100000063', '1010000000643', 1, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (2006, 'Рублевый эквивалент(643)', 933, '1010000000643', '6911000000643', 0, NULL);
INSERT INTO `zagurskaya`.`sprEntries` (`id`, `name`, `currencyId`, `accountDebit`, `accountCredit`, `isSpending`, `rate`) VALUES (99801, 'Приход денежных средст в кассу', 933, '1010000000933', '3819000000000', 0, NULL);
...
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya`.`sprOperations` (`id`, `name`, `printForm`, `screenForm`, `specification`) VALUES (1000, 'Подкрепление', 'order1000', 'prix', '');
INSERT INTO `zagurskaya`.`sprOperations` (`id`, `name`, `printForm`, `screenForm`, `specification`) VALUES (10, 'Покупка валюты', 'print10', 'screen10', '');
INSERT INTO `zagurskaya`.`sprOperations` (`id`, `name`, `printForm`, `screenForm`, `specification`) VALUES (20, 'Продажа валюты', 'print20', 'screen20', '');
INSERT INTO `zagurskaya`.`sprOperations` (`id`, `name`, `printForm`, `screenForm`, `specification`) VALUES (998, 'Коммунальный платеж', 'print998', 'screen998', NULL);
INSERT INTO `zagurskaya`.`sprOperations` (`id`, `name`, `printForm`, `screenForm`, `specification`) VALUES (1100, 'Инкассация', 'order1100', 'rasx', NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `zagurskaya`.`operationHasEntries`
-- -----------------------------------------------------
START TRANSACTION;
USE `zagurskaya`;
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 1000, 100001);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 1000, 100002);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 1000, 100003);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 1000, 100004);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 10, 1001);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 10, 1002);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 10, 1003);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 10, 1004);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 10, 1005);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 10, 1006);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 20, 2001);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 20, 2002);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 20, 2003);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 20, 2004);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 20, 2005);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 20, 2006);
INSERT INTO `zagurskaya`.`operationHasEntries` (`id`, `operationId`, `entryId`) VALUES (DEFAULT, 998, 99801);
