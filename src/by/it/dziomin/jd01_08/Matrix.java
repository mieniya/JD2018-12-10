...
public class Matrix extends Var {
    ...
    public Var mul(Var other) {
        ...
        if (other instanceof Vector && this.getValue()[0].length == ((Vector) other).getValue().length) {
        ...
        if (other instanceof Matrix && this.getValue()[0].length == ((Matrix) other).getValue().length) {
